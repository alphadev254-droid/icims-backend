...
<head>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: Arial, sans-serif; padding: 36px; background: #f5f5f5; color: #111827; }
    .invoice { background: white; max-width: 760px; margin: 0 auto; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.12); }
    .header { background: linear-gradient(135deg, #111827 0%, #1e3a8a 100%); color: white; padding: 34px 40px; border-bottom: 5px solid #d4a574; }
    .brand { font-size: 13px; letter-spacing: 3px; text-transform: uppercase; color: #f4d39b; font-weight: 700; margin-bottom: 10px; }
    ...
    .status { display: inline-block; background: #fef3c7; color: #92400e; border-radius: 999px; padding: 5px 12px; font-size: 12px; font-weight: 700; text-transform: uppercase; }
    table { width: 100%; border-collapse: collapse; margin-top: 10px; }
    th { background: #202c3c; color: white; font-size: 12px; text-align: left; padding: 12px; }
    ...
    .amount { color: #1e3a8a; font-size: 28px; font-weight: 800; }
    .note { margin-top: 22px; background: #fffbeb; border-left: 4px solid #d4a574; padding: 16px; border-radius: 6px; }
    .note h3 { font-size: 13px; margin-bottom: 8px; color: #92400e; }
