...
export const registrationTemplate = (data: { firstName: string; lastName: string; email: string; roleName?: string }) => `
<!DOCTYPE html>
<html>
<head>${baseStyle}</head>
<body>
...
export const passwordChangedTemplate = (data: { firstName: string; email: string }) => `
<!DOCTYPE html>
<html>
<head>${baseStyle}</head>
<body>
